<%@ page import="com.example.sample_member_servelt.dto.MemberDTO" %>
...
<body onload="init()">
	...
	<div class="container">
		<form name="newMember" class="form-horizontal" action="/member/modifyMemberAction" method="post" onsubmit="return checkForm()">
			...
			<div class="form-group  row">
				<div class="col-sm-offset-2 col-sm-10 ">
					...
					<a href="../../../member/deleteMember.jsp" class="btn btn-primary">회원탈퇴</a>
				</div>
			</div>
		</form>	
	</div>
